...
import PadInputPictureDropdown from "./PadInputPictureDropdown.vue";
import { ButtonPictSetting } from "@/button-pict-setting";
import store from "@/store";
import { useToast } from "vue-toast-notification";

export default defineComponent({
  name: "PadInputDisplayKeySettings",
  emits: ["onSaveButtonSetting", "onDeleteButtonSetting"],
  components: {
    PadInputPictureDropdown,
  },
  props: {
    presetName: {
    ...
    <div class="row">
      <div class="col">
        <div class="alert alert-info" role="alert">
          ...
          ボタン押下時に表示する画像・座標を設定して「保存」ボタンを押してください。<br />
  ...
  <div class="d-flex">
    ...
    <div class="container-fluid mt-3">
      <div class="row text-center">
        ...
        <div class="col">画像1</div>
        <div class="col">画像2</div>
        <div class="col">画像3</div>
      </div>

      <hr />

      <div class="mb-2 row justify-content-center align-items-center">
        <div class="col-2">ベース画像</div>
        <div class="col">
          <PadInputPictureDropdown
            :buttonIndex="-1"
            :buttonPromptIndex="0"
