...
<template>
  <div class="container d-grid d-flex gap-1 align-items-center mb-2">
    <select
      :id="dropdownHTMLId"
      class="form-select"
  ...
  <div v-if="isEnablePosition" class="container d-flex gap-5">
    <div>
      <label class="form-label mb-0">X座標</label>
      <input type="text" class="form-control" />
    </div>
    <div>
      <label class="form-label mb-0">Y座標</label>
      <input type="text" class="form-control" />
    </div>
  </div>
</template>
